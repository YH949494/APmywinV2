...
# Accept either hashtag (case-insensitive); optional second tag and/or "+" before game name
TAG_PATTERN = re.compile(r'^\s*#(?P<tag>mywin|comebackisreal)(?:\s+#(?:mywin|comebackisreal))?\s+(?:\+\s+)?(?P<game>.+)$', re.IGNORECASE)
